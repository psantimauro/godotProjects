...
func _ready() -> void:
	GameEvents.new_material_unlocked.connect(_on_new_material_unlocked)
...
func _on_objective_added(quest: QuestResource, objective: QuestObjective):
	...
	if quest_type == "main":
		GameEvents.quest_status_changed.emit(quest, quest_status_types.UPDATED, objective.description, quest_type)
...
func _on_quest_completed(quest: QuestResource):
	...
	var quest_type = quest.get_meta("quest_type")
	GameEvents.quest_status_changed.emit(quest, quest_status_types.COMPLETED, "Complete", quest_type)
...
func add_quest(quest):
	...
	GameEvents.quest_status_changed.emit(quest, quest_status_types.STARTED, quest.description, quest_type)
